...
function thanaList(){
	...
	if(DisList == 'Madaripur') {
		var thanaList = '<option value="">Select One</option><option value="Madaripur Sadar">Madaripur Sadar</option><option value="Kalkini">Kalkini</option><option value="Rajoir">Rajoir</option><option value="Shibchar">Shibchar</option><option value="Others">Others</option>';
	}
	if(DisList == 'Magura') {
	...
	document.getElementById("thana_print").innerHTML= thanaList;
}